Excel files (apart from one, which is in .txt(convertable to .csv), because of Excel exporting limits) represent the data from the database of the Blinken OSA's RFE/FEC Collection of telex messages. 
